...
RSpec.describe SensorsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all sensors as @sensors" do
      ...
      expect(assigns(:sensors)).to eq([sensor])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created sensor as @sensor" do
        post :create, {:sensor => valid_attributes}, valid_session
        expect(assigns(:sensor)).to be_a(Sensor)
        expect(assigns(:sensor)).to be_persisted
      end

      it "redirects to the created sensor" do
        post :create, {:sensor => valid_attributes}, valid_session
        expect(response).to redirect_to(Sensor.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved sensor as @sensor" do
        post :create, {:sensor => invalid_attributes}, valid_session
        expect(assigns(:sensor)).to be_a_new(Sensor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested sensor" do
        sensor = Sensor.create! valid_attributes
        put :update, {:id => sensor.to_param, :sensor => new_attributes}, valid_session
        sensor.reload
      ...
      it "redirects to the sensor" do
        sensor = Sensor.create! valid_attributes
        put :update, {:id => sensor.to_param, :sensor => valid_attributes}, valid_session
        expect(response).to redirect_to(sensor)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the sensor as @sensor" do
        sensor = Sensor.create! valid_attributes
        put :update, {:id => sensor.to_param, :sensor => invalid_attributes}, valid_session
        expect(assigns(:sensor)).to eq(sensor)
      end
