...
RSpec.describe DataPointsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all data_points as @data_points" do
      ...
      expect(assigns(:data_points)).to eq([data_point])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created data_point as @data_point" do
        post :create, {:data_point => valid_attributes}, valid_session
        expect(assigns(:data_point)).to be_a(DataPoint)
        expect(assigns(:data_point)).to be_persisted
      end

      it "redirects to the created data_point" do
        post :create, {:data_point => valid_attributes}, valid_session
        expect(response).to redirect_to(DataPoint.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved data_point as @data_point" do
        post :create, {:data_point => invalid_attributes}, valid_session
        expect(assigns(:data_point)).to be_a_new(DataPoint)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested data_point" do
        data_point = DataPoint.create! valid_attributes
        put :update, {:id => data_point.to_param, :data_point => new_attributes}, valid_session
        data_point.reload
      ...
      it "redirects to the data_point" do
        data_point = DataPoint.create! valid_attributes
        put :update, {:id => data_point.to_param, :data_point => valid_attributes}, valid_session
        expect(response).to redirect_to(data_point)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the data_point as @data_point" do
        data_point = DataPoint.create! valid_attributes
        put :update, {:id => data_point.to_param, :data_point => invalid_attributes}, valid_session
        expect(assigns(:data_point)).to eq(data_point)
      end
